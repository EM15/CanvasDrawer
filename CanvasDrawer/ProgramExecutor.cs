...
namespace CanvasDrawer
{
    public class ProgramExecutor
    {
        ...
        public ProgramExecutor(ICommandValidator commandValidator, IFigureCreator figureCreator, IDrawingValidator drawingValidator,
        ...
        public void Execute()
        {
            ...
            while (command != "Q")
            {
                ...
                if (!isValid)
                {
                    consoleWriter.WriteLine("Invalid command");
